...
public final class StringTools extends StringUtils {
	...
	private static Log logger = LogFactory.getLog(StringTools.class);
	 ...
	 * @return
	 */
	public static boolean isValidateCheck(String signature, String timestamp,
