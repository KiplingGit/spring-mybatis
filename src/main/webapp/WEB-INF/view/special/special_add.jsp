        ...
        <!-- 专题详情 -->
          <form id="frm" action="${ctx}/special_save" method="post" enctype="multipart/form-data">
            ...
            <div class="widthHeight overflowHidden shopAdd_option_div">
                ...
                <div class="floatLeft fontColor shopAdd_option_conDiv">
                    <textarea class="commodity_textarea" id="txtImgDetail" name="txtImgDetail" style="width:700px; height:400px;" ></textarea>
                </div>
            </div>
            <div class="widthHeight overflowHidden shopAdd_option_div">
...
KindEditor.ready(function(K){
    editor = K.create("textarea[id='txtImgDetail']",{
        resizeType : 1,
        allowPreviewEmoticons: false,
        allowImageUpload:true,//允许上传图片
        allowFileManager:true, //允许对上传图片进行管理
        allowImageRemote : true, //允许上传网络图片
        uploadJson: ctx + '/uploadFile/upload2',
        ...
        afterBlur: function(){ //失去焦点时，将上传内容同步到textarea中
        	this.sync();
        },  
       /*  items : [
