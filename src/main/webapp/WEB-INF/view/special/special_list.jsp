        ...
        <div class="rightCon_conDiv specialList_div paddingBottom50">
            <div class="widthHeight search_div">
                ...
                <div class="search_condition_div">
                    ...
                    <input type="text" class="search_condition_inputMore" placeholder="起始"/>
                    <span>~</span>
                    <input type="text" class="search_condition_inputMore" placeholder="结束"/>
                </div>
                <div class="search_condition_div">
                    <select>
                        <option selected>审核人</option>
                        <option>审核人1</option>
                        <option>审核人2</option>
                    </select>
                ...
                <!-- <input type="button" value="添加" class="inputButton" onclick="window.open('special_add.html')"/> -->
                <input type="button" value="添加" class="inputButton" onclick="location.href='${ctx}/special_add'"/>
            </div>
            ...
            <table class="list_table" cellspacing="0" cellpadding="0">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>5/12/32</td>
                        <td>已发布</td>
                        <td class="commodity_operation"><a href="#">详情</a><a href="#">预览</a><a href="#">发布</a></td>
                    </tr>
                </tbody>
            </table>
